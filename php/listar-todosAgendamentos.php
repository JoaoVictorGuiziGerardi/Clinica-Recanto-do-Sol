<?php
  ...
  try{
    $sql = <<<SQL
        SELECT nome_paciente, agenda.email, sexo_paciente, especialidade, nome, data_consulta, horario_consulta FROM agenda
        ...
        <nav>
            ...
            <section>
                <ul id="nav">
                    ...
                    <li> <a href="listar-todosAgendamentos.php"> <b>Listar Todos Agendamentos</b> </a> </li>
                    <?php
                        $id = ehMedico($pdo);
